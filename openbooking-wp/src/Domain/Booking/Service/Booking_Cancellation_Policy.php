...
/**
 * Decide si una reserva puede cancelarse.
 */
class Booking_Cancellation_Policy {
    ...
    public function can_cancel( Booking_Entity $booking ): bool {
        ...
        $min_hours = (int) $this->settings->get( Setting_Keys::CANCEL_MIN_HOURS, 0 );
        ...
        return (bool) $this->hooks->apply_filters( 'openbooking_booking_can_be_cancelled', true, $booking );
    }
